    ...
    >
      <div className="mx-auto py-[2rem] md:py-[5rem] lg:gap-10">
        <div className="flex flex-col items-center w-[80%] md:w-[70%] lg:w-[55%] mx-auto lg:justify-center">
          <h2
            className="text-3xl text-center md:text-4xl font-black mb-5 text-blue-800 opacity-0 mx-auto"
            ref={useAnimateFadeUp}
          >
            Transforma tu Sonrisa con Odontología Estética <br/>🌟
          </h2>
          <p
            className="text-md text-center mt-1 mb-4 text-black mx-0 md:text-md op"
